...
class AllUsers extends Component{
    ...
    componentDidMount() {
        ...
        axios.get('http://pairecdb.herokuapp.com/person/pages')
          .then(response => {
          ...
          axios.get('http://pairecdb.herokuapp.com/person/pages?page=1')
          .then(response => {
              this.setState({
    ...
    nextPage() {
        ...
        axios.get(`http://pairecdb.herokuapp.com/person/pages?page=${n}`)
          .then(response => {
              this.setState({
                  "persons": response.data.data,
